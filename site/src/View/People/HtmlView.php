...
class HtmlView extends BaseHtmlView {
    ...
    public function display($template = null)
    {
        ...
        // useful:
        //$this->setModel($this->getModel('people'));
        #jimport('joomla.application.component.model');
        #JModelLegacy::addIncludePath(JPATH_SITE . '/components/com_people/models');
        require JPATH_SITE . '/components/com_people/models/person.php';
        $people_model = JModelLegacy::getInstance('Personform', 'PeopleModel');
        #echo '<pre>'; var_dump($people_model); echo '</pre>'; exit;
        $form = $people_model->getForm();
