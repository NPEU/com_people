 ...
 *
 */
class FormModel extends \NPEU\Component\People\Administrator\Model\PersonModel
{
    ...
    public function getTable($name = 'Person', $prefix = 'Administrator', $options = array())
    {
    ...
    /**
     * Prepare a people record for saving in the database
     */
