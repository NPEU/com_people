...
/**
 * Person Component Controller
 *
 * Used to handle the http POST from the front-end form which allows users to enter a new person
 */
class PersonController extends FormController
{
    ...
    public function __construct($config = array())
    {
        ...
        $this->view_item = $input->get("view", "person", "string");
    ...
    public function cancel($key = null)
    {
        ...
        /*$this->setRedirect(
            ...
            Text::_('COM_PEOPLE_ADD_CANCELLED')
        );*/
    ...
    /*
     * Function handing the save for adding a new people record
     ...
     * @since   1.5
     */
    public function getModel($name = 'Form', $prefix = 'People', $config = ['ignore_request' => true])
    {
