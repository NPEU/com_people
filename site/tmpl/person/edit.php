...
<form action="<?php echo $uri; ?>" method="post" name="people_form" id="<?php echo $form_id; ?>" class="">
    <?php
    ...
    <fieldset>
        ...
        <?php endif; ?><?php endforeach; ?>
        <?php /*
        <button class="btn" type="submit"><?php echo Text::_('COM_PEOPLE_SUBMIT_LABEL'); ?></button>
        <a class="btn" href="<?php echo Route::_('index.php?option=com_people'); ?>"><?php echo Text::_('JCANCEL') ?></a>
        */ ?>
        <button type="submit" name="task" value="person.save"><strong><?php echo Text::_('COM_PEOPLE_SUBMIT_LABEL'); ?></strong></button>
        <?php if (!empty($item_id)) : ?>
        <button type="submit" name="task" value="person.cancel"><?php echo Text::_('JCANCEL') ?></button>
        <?php else : ?>
        <a href="<?php echo Route::_('index.php?option=com_people&task=person.abort'); ?>"><?php echo Text::_('JCANCEL') ?></a>
        <?php endif; ?>
    </fieldset>
</form>
